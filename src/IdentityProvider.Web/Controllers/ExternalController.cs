...
namespace IdentityProvider.Controllers
{
    ...
    public class ExternalController
    {
        ...
        //private async Task<(Account user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        //private async Task<Account> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        //{
